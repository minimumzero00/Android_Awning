...
import com.example.project.databinding.Fragment02Binding
...
class Fragment02 : Fragment() {
    ...
    private var _binding: Fragment02Binding? = null //(추가)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        _binding = Fragment02Binding.inflate(inflater, container, false) //(추가)
