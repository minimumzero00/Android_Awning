...
import com.example.project.databinding.Fragment01Binding
...
class Fragment01 : Fragment() {
    ...
    private var _binding: Fragment01Binding? = null //(추가)
    ...
    override fun onCreateView(
        ...
        //return inflater.inflate(R.layout.fragment_01, container, false) //(원본)
        _binding = Fragment01Binding.inflate(inflater, container, false) //(추가)
